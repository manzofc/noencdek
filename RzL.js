...
const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        if(time2 < "04:00:00"){
        var ucapanWaktu = 'ᴍᴀʟᴀᴍ 🌌'
}
        if(time2 < "17:30:00"){
        var ucapanWaktu = 'ᴍᴀɢʜʀɪʙ 🌆'
}
        if(time2 < "16:00:00"){
        var ucapanWaktu = 'sᴏʀᴇ 🌇'
}
        if(time2 < "14:00:00"){
        var ucapanWaktu = 'sɪᴀɴɢ 🏞'
}
        if(time2 < "06:00:00"){
        var ucapanWaktu = 'ᴘᴀɢɪ 🌅'
}
        if(time2 < "05:00:00"){
        var ucapanWaktu = 'sᴜʙᴜʜ 🏙'
}
...
var dDisplay = d > 0 ? d + (d == 1 ? " ʜᴀʀɪ, " : " ʜᴀʀɪ, ") : "";
var hDisplay = h > 0 ? h + (h == 1 ? " ᴊᴀᴍ, " : " ᴊᴀᴍ, ") : "";
var mDisplay = m > 0 ? m + (m == 1 ? " ᴍᴇɴɪᴛ, " : " ᴍᴇɴɪᴛ, ") : "";
var sDisplay = s > 0 ? s + (s == 1 ? " ᴅᴇᴛɪᴋ" : " ᴅᴇᴛɪᴋ") : "";
...
\`\`\`❏「 🄸🄽🄵🄾 🄱🄾🅃 」\`\`\`
${gaya1} *sᴘᴇᴇᴅ* : ${latensie.toFixed(4)} ᴅᴇᴛɪᴋ
${gaya1} *ʀᴜɴᴛɪᴍᴇ* : ${runtime(process.uptime())}
${gaya1} *ɴᴀᴍᴀ ʙᴏᴛ* : ${botname}
${gaya1} *ɴᴀᴍᴀ ᴏᴡᴍᴇʀ* : ${ownername}
${gaya1} *ɴᴏᴍᴏʀ ᴏᴡɴᴇʀ* : @${pemilik.split('@')[0]}
${gaya1} *ʜᴏsᴛɴᴀᴍᴇ :* ${os.hostname()}
${gaya1} *ᴘʟᴀᴛғᴏʀᴍ :* ${os.platform()}
${gaya1} *ᴡᴀ ᴠᴇʀsɪᴏɴ :* ${RzL.user.phone.wa_version}
${gaya1} *ᴛᴏᴛᴀʟ ᴘᴇɴɢɢᴜɴᴀ :* ${_registered.length}
${gaya1} *ᴍᴏᴅᴇ :* ${self ? "sᴇʟғ" : "ᴘᴜʙʟɪᴄ"}
${gaya1} *ᴀᴜᴛᴏʀᴇᴀᴅ* : ${autoread ? "ᴀᴋᴛɪғ" : "ᴏғғ"}
${gaya1} *ᴀᴜᴛᴏ ᴋᴇᴛɪᴋ* : ${autoketik ? "ᴀᴋᴛɪғ" : "ᴏғғ"}
${gaya1} *ᴀᴜᴛᴏ ᴠɴ* : ${autovn ? "ᴀᴋᴛɪғ" : "ᴏғғ"}


\`\`\`❏「 🄸🄽🄵🄾 🅄🅂🄴🅁 」\`\`\`
${gaya1} *ɴᴀᴍᴀ* : ${pushname}
${gaya1} *ʙɪᴏ* : ${bio_user}
${gaya1} *ɴᴏᴍᴏʀ* : @${senderr.split('@')[0]}
${gaya1} *sᴛᴀᴛᴜs* : ${isOwner ? 'Owner' : 'User'}`
teks =
...
───────────────
\`\`\`ᴏᴘᴇɴ ᴍᴜʀɪᴅ :\`\`\`
➪ *ᴍᴜʀɪᴅ ʙɪᴀsᴀ :* _20.000_
➪ *ᴍᴜʀɪᴅ ᴘʀᴇᴍɪᴜᴍ :* _50.000_

\`\`\`OPEN BUAT SC :\`\`\`
➪ *sᴄʀɪᴘᴛ sᴛᴏʀᴇ :* _ʜᴜʙᴜɴɢɪ ᴏᴡɴᴇʀ_
➪ *sᴄʀɪᴘᴛ ʙɪᴀsᴀ :* _ʜᴜʙᴜɴɢɪ ᴏᴡɴᴇʀ_
ᴜɴᴛᴜᴋ ʏᴀɴɢ ᴍᴀᴜ ʙᴇʟɪ sᴄ
ʙɪsᴀ ʀᴇǫᴜᴇsᴛ ʜᴜʙᴜɴɢɪ ᴍᴀɴᴢʙᴏᴛ
ɴᴏᴍᴏᴛ : wa.me/6283830930643`
...
• ɢᴏᴘᴀʏ : _sᴄᴀɴ ᴅɪ ᴀᴛᴀs ɴɢᴀʙ_
• ᴅᴀɴᴀ : _sᴄᴀɴ ᴘᴘ ʙᴏᴛ_
• ᴏᴠᴏ : _sᴄᴀɴ ᴘᴘ ʙᴏᴛ_
• ǫʀɪs ᴀʟʟᴘᴀʏ : _sᴄᴀɴ ᴘᴘ ʙᴏᴛ_
• ᴘᴜʟsᴀ : _(TIDAK TERSEDIA)_
• _ɴᴏᴛᴇ :ᴋɪʀɪᴍ ʙᴜᴋᴛɪ ᴛғ ᴅɪ ᴏᴡɴᴇʀ !_`
but = [
...
case 'sourcode':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
fakeitem(`_Apa Mau Sc?Buy Ajg Modal Napa Nih Wa Owner Gua wa.me/6283830930643_`)
break
case 'rules':
case 's&k':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
punten = [{buttonId: `${prefix}nsfw on`, buttonText: {displayText: 'ᴏɴ'}, type: 1},{buttonId: `${prefix}nsfw off`, buttonText: {displayText: 'ᴏғғ'}, type: 1}]
const btngrass = {
contentText: `${anu}`,
...
anu =`Silahkan pilih salah satu\nUntuk fitur welcome`
punten = [{buttonId: `${prefix}welcome on`, buttonText: {displayText: 'ᴏɴ'}, type: 1},{buttonId: `${prefix}welcome off`, buttonText: {displayText: 'ᴏғғ'}, type: 1}]
const btngrass = {
contentText: `${anu}`,
footerText: `© ${ownername} || 2022`,
buttons: punten,
...
punten = [{buttonId: `${prefix}antilink on`, buttonText: {displayText: 'ᴏɴ'}, type: 1},{buttonId: `${prefix}antilink off`, buttonText: {displayText: 'ᴏғғ'}, type: 1}]
const btngrass = {
contentText: `${anu}`,
footerText: `© ${ownername} || 2022`,
buttons: punten,
...
punten = [{buttonId: `${prefix}antivirtex on`, buttonText: {displayText: 'ᴏɴ'}, type: 1},{buttonId: `${prefix}antivirtex off`, buttonText: {displayText: 'ᴏғғ'}, type: 1}]
const btngrass = {
contentText: `${anu}`,
footerText: `© ${ownername} || 2022`,
buttons: punten,
